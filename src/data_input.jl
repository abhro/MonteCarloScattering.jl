...
function check_pcuts(pcuts, Emax, Emax_per_aa, pmax)
    ...
    if Emax > 0keV
        ...
        if Emax > Emax_eff
            error(
                "PCUTS: max energy exceeds highest pcut. Add more pcuts or lower Emax. ",
    ...
    elseif Emax_per_aa > 0keV   # Limit was on energy per nucleon
        ...
        if Emax_per_aa > Emax_eff_per_aa
            error(
                "PCUTS: max energy per aa exceeds highest pcut. Add more pcuts or lower Emax_per_aa. ",
    ...
    elseif pmax > 0g * c # Limit was on total momentum. Assume Fe for strictest limit on mom/nuc.
        ...
        if pmax > pmax_eff
            error(
                "PCUTS: max momentum exceeds highest pcut. Add more pcuts or lower pmax. ",
